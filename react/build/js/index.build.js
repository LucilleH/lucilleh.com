...
/***/ function(module, exports, __webpack_require__) {
	...
	var Projects = __webpack_require__(160);
	...
	var Header = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement("img", { src: "./public/img/circle.gif", width: "150px" }),
	      React.createElement(
	        "h1",
	        { className: "title" },
	        "Lucille H"
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        'Entering fourth year at McGill University in Montreal, Canada, I major in software engineering and minor in music technology. I\'m currently a student, but I\'m also:'
	      ),
	      React.createElement(
	        'ul',
	        null,
	        ...
	        React.createElement(
	          'li',
	          null,
	          'Past developer at Ericsson, working part time'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'USG-IT for SSUNS 2013, SSUNS 2014'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Web developer for McGill Engineering Competition 2014'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'Past developer of Digital Prosopography at ',
	          React.createElement(
	            'a',
	        ...
	        React.createElement(
	          'li',
	          null,
	          'Past web developer of Student Offering Support ',
	          React.createElement(
	            'a',
	            { href: 'http://www.studentsofferingsupport.ca/portal/login.php' },
	            'Portal'
	          )
	        ),
	        React.createElement(
	          'li',
	          null,
	          'A guitarist who knows how to play ',
	          React.createElement(
	            'a',
	            { href: 'http://www.youtube.com/watch?v=Ddn4MGaS3N4' },
	            'Drifting'
	          ),
	          ' by Andy McKee'
	        ),
	        React.createElement(
	          'li',
	          null,
	          'A music composer who does not know how to hand-write music notes'
	        ),
	        React.createElement(
	          'li',
	          null,
	      ...
	      React.createElement(
	        'p',
	        null,
	        'Below are my contact info if you want to hit me up:'
	      ),
	      React.createElement(
	        'ul',
	        null,
	        React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { href: 'mailto:lucille.hua@gmail.com' },
	            'lucille.hua@gmail.com'
	          )
	        ),
	        React.createElement(
	          'li',
	          ...
	          React.createElement(
	            'a',
	            { href: 'https://www.facebook.com/lucille.hua' },
	            'lucille.hua'
	          )
	        ),
	        React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { href: 'http://www.linkedin.com/pub/lucille-hua/27/232/862' },
	            'Lucille Hua'
	          )
	        )
	      )
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            'a',
	            { href: this.props.readmore, target: '_blank' },
	            'Read more »'
	          )
	        )
	      )
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        'p',
	        null,
	        'The following projects are ones I am heavily involved in for the past years, described in summary, with link for each of them. Feel free to contact me if you are particularly interested in these projects.'
	      ),
	      React.createElement(ProjectDescription, {
	        url: 'http://ssuns.org',
	        img: './public/img/ssuns.png',
	        title: 'Secondary Schools\' United Nations Symposium',
	        description: 'Attracting over 1,100 secondary school students from across  the globe, SSUNS is the largest and most renowned high school level model  United Nations Conference in Canada. As USG IT, I was responsible for website  rontend backend registration system, etc.',
	        readmore: 'https://github.com/LucilleH/ssuns-2014' }),
	      React.createElement(ProjectDescription, {
	        url: '../project/rmg.html',
	        img: './public/img/rsz_rmg.png',
	        title: 'Random Music Generator',
	        description: 'This random music generator software generates music notes  based on user input (music scale, tempo, etc) and common music theory.  It is done in real time. The purpose of this random music generator is  to help me, and the rest of the musicians, deal with those hard time when  we run out of ideas.',
	        readmore: './project/rmg.html' }),
	      React.createElement(ProjectDescription, {
	        url: 'http://mec.mcgilleus.ca',
	        img: './public/img/mec_logo.png',
	        title: 'MEC (McGill Engineering Competition)',
	        description: 'MEC is an event gathering McGill Engineers to compete against  each other. The goal of the competition is to foster relationships between  students while providing them a setting for professional engineering practice  as well as networking opportunities. I\'m the IT Director for year 2014.',
	        readmore: 'http://mec.mcgilleus.ca' }),
	      React.createElement(ProjectDescription, {
	        url: 'http://mcgill.soscampus.com/',
	        img: './public/img/sos.gif',
	        title: 'Students Offering Support',
	        description: 'Students Offering Support: McGill Chapter is a network of  student volunteers working together to raise funds to raise the quality of  education and life for those in developing nations through raising marks of  our fellow University students. Was IT of head quarter back in 2011.',
	        readmore: 'http://mcgill.soscampus.com/' }),
	      React.createElement(ProjectDescription, {
	        url: './project/prosopography.html',
	        img: './public/img/rdf.png',
	        title: 'Digital Prosopography',
	        description: 'Human history project called Digital Prosopography aims to turn  uman history digital text records to a relational web representation.  It extracts the semantic meaning from text input, stores in rdf format with  specific model, and present it as network graph of historical events.',
